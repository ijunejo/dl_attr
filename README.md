...
<br> **model** folder: contains the code for the model, working on GPU.

# Citation

@article{DBLP:journals/access/Junejo21,
<br>  author    = {Imran N. Junejo},
<br>  title     = {Multi-Branch Gabor Wavelet Layers for Pedestrian Attribute Recognition},
<br>    journal   = {{IEEE} Access},
  <br>  volume    = {9},
  <br>  pages     = {40019--40026},
  <br>  year      = {2021}
<br>  }
